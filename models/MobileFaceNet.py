...
class MobileFacenet(nn.Module):
    def __init__(self, bottleneck_setting=Mobilefacenet_bottleneck_setting):
        ...
        feature_dim = 64 #　特征为128时，参数为64，特征为512时，参数为256
        self.linear1 = ConvBlock(512, 64, 1, 1, 0, linear=True) 
...
class MobileFacenet_IR(nn.Module):
    def __init__(self, bottleneck_setting=Mobilefacenet_bottleneck_setting):
        super(MobileFacenet_IR, self).__init__()
        ...
        self.linear1 = ConvBlock(512, 256, 1, 1, 0, linear=True)
...
def mobilefacenet_IR():
    return MobileFacenet_IR()
